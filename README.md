...
6.3 Main Loop Flow
Read lower sensor distance using ultrasonic_read(PA1, PA2).
Read upper sensor distance using ultrasonic_read(PA3, PA4).
Compare both values against thresholds:
Lower: 40 cm
Upper: 80 cm
Update LCD with detection result:
CHILD DETECTED
ADULT DETECTED
NO PERSON
...
IDE: STM32CubeIDE
Project: STM32 Embedded Systems Project | Child / Adult Detection System | 2026
